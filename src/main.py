...
from tasks.actitvities_extraction import ActivityExtraction, ActivityExtractionMarker,ActivityList, ActivitySentence
...
mapper = Mapper(ActivityList)

result = mapper.map(result,"json object contains string with is the name of the activity")
