...
from routes.activities_relationships_extraction import router as activities_relationships_extraction
...
app.include_router(activities_relationships_extraction)
